                    ...
                    return (
                        <ServiceBox key={id}>
                            <div className="d-flex justify-content-between">
                                <div>
                                    <h5>
                                        <Field text="Рег. номер" value={clientCar.license_plate} />
                                    </h5>
                                    <h5>{inlineCar}</h5>
                                    <p>
                                ...
                                <div>{/* <button className='btn btn-warning'>Редактирай автомобила</button> */}</div>
                            </div>
                            <hr />
                            ...
                            <div className="d-flex justify-content-between">
                                <div>
                                    ...
                                    {next_hydraulics_oil_change && (
                                        <Field text="Следваща смяна на хидравликата" value={next_hydraulics_oil_change} />
                                    )}
                                    {next_gearbox_oil_change && (
                                        <Field text="Следваща смяна на масло скоростна к-я" value={next_gearbox_oil_change} />
                                    )}
