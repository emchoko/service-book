            ...
            <div className="row">
                <div className="col-12">
                    <div className="d-flex justify-content-between align-items-center mb-3">
                        <h4>Резултати:</h4>
                        <button className="btn btn-success btn-sm" disabled={isLoading} onClick={refresh}>Обнови</button>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="input-group mb-3">
                            ...
                            <button className="ml-5 btn btn-outline-primary" onClick={() => handleOnSelect(inputValue)}>Напред</button>
                        </div>
                    </div>
                </div>
            </div>
