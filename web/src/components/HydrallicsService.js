  ...
  return (<>
    <ServiceBox>
      ...
      <FluidFields dispatch={props.dispatch} img={require('../images/steering_wheel.png')} fluid_value={props.oil_hydraulics_amount} field_name={'oil_hydraulics_amount'} fluid_name={'oil_hydraulics'}
        ...
        // viscosity data
        viscosity_data={props.viscosity_variety} set_viscosity_variety={props.set_viscosity_variety} oil_viscosity={props.oil_hydraulics_viscosity} dropdown_field_name_viscosity={'oil_hydraulics_viscosity'} />

      <NextChangeIn dispatch={props.dispatch} oil_change_options={OilData.oil_hydraulics_change_options} next_change_km={props.next_hydraulics_change_km} field_name={'next_hydraulics_change_km'} />
    </ServiceBox>
  </>);
}
